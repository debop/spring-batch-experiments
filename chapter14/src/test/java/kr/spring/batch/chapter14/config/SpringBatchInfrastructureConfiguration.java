...
public class SpringBatchInfrastructureConfiguration {

    @Bean
    public PropertyPlaceholderConfigurer placeHolderProperties() throws Exception {

        SpringBatchInfrastructureConfiguration.log.info("create PropertyPlaceholderConfigurer");
...
//        configurer.setOrder(1);
    ...
    public JobRepository jobRepository(@Qualifier("jobDataSource") DataSource dataSource,
        ...
        SpringBatchInfrastructureConfiguration.log.info("create JobRepository...");

...
public class DetectDuplicateTest {
    ...
    public void setUp() throws Exception {
        ...
        for (int i = 1; i < 15; i++) {
//			OrderEntity order = new OrderEntity(String.valueOf(i), false);
//			orderRepository.save(order);
    ...
    private OrderEntity createOrder(String orderId, OrderItem... items) {
        OrderEntity order = new OrderEntity(orderId, false);

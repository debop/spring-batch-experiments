...
/**
 * kr.experiments.springbatch.test.stop.StopWithJavaConfigTest
 *
 * @author 배성혁 sunghyouk.bae@gmail.com
 * @since 13. 8. 1. 오전 9:47
 */
@Slf4j
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = { StopJobConfiguration.class })
public class StopWithJavaConfigTest {

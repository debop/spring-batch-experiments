...
/**
 * kr.spring.batch.chapter04.test.web.WebTest
 *
...
public class WebTest {
    ...
    private void startWebContainer() throws Exception {
        ...
        try {
            ...
            //
            wac.setWar(ClassLoader.getSystemResource("kr/spring/batch/chapter04/test/web/webapp/").toString());
            // wac.setWar("src/test/resources/kr/spring/batch/chapter04/test/web/webapp/");

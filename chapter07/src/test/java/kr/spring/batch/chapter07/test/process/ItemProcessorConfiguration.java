...
public class ItemProcessorConfiguration extends AbstractJobConfiguration {
    ...
    public static final String OUTPUT_FILE = "target/output.txt";

    @Bean
    @StepScope
    public FlatFileItemWriter<Product> productItemWriter(@Value("#{jobParameters['targetFile']}") String targetFile) {

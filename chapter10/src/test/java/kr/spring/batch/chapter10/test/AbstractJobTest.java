...
/**
 * kr.spring.batch.chapter10.test.AbstractJobTest
 *
 * @author 배성혁 sunghyouk.bae@gmail.com
 * @since 13. 8. 16. 오후 4:32
 */
public abstract class AbstractJobTest {
	...
	private void recordBehaviorDownloadedFileOkNoSkippedItems() throws Exception {
	...
	private void assertPostConditionsDownloadFileOkSkippedItems(JobExecution jobExecution) throws Exception {
		assertEquals(BatchStatus.COMPLETED, jobExecution.getStatus());

...
//		                      "classpath:kr/spring/batch/chapter10/transmit-data-job-context-late-binding-job.xml" })
@ContextConfiguration(classes = { TransmitDataJobContextLateBindingTest.JobConfiguration.class })
public class TransmitDataJobContextLateBindingTest extends AbstractJobTest {
	...
	@ImportResource({ "classpath:kr/spring/batch/chapter10/transmit-data-job-context-late-binding-job.xml" })
